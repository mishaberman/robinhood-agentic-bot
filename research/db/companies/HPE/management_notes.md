...
Role: secondary infrastructure candidate
Priority: 7
Theme: Cloud & AI, networking, hybrid cloud infrastructure
...
- DELL/SMCI/server peers strong
- margin not deteriorating
- networking strength

Disqualifiers:
- margin/integration concerns dominate
- weak relative strength vs DELL

Source/context notes:
- HPE Q2 FY2026 materials: Cloud & AI segment net revenue $7.707B; total segment net revenue $10.678B

Monitor instruction:
- Use this note as ticker-specific context only. Do not treat it as a standing order. Require fresh catalyst, clean price action, liquidity, and risk/reward before raising TRADE REVIEW for HPE.
