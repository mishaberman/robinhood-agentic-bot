...
Priority: 2
Theme: AI data workload storage and cloud/hyperscaler capacity
...
Disqualifiers:
- sympathy-only move without volume
- MU fades
- wide stop

Source/context notes:
- Western Digital IR emphasizes AI-driven data workloads and latest Q3 FY2026 results

Monitor instruction:
- Use this note as ticker-specific context only. Do not treat it as a standing order. Require fresh catalyst, clean price action, liquidity, and risk/reward before raising TRADE REVIEW for WDC.
