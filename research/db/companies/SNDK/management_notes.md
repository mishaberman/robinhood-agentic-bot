...
| 2026-07-02 | BiCS10 NAND sampling | [Sandisk IR release](https://investor.sandisk.com/news-releases/news-release-details/sandisk-announces-sampling-bics10-1tb-tlc-3d-nand-flash-memory) | BiCS10 sampling supports longer-term enterprise SSD/NAND cost-performance roadmap for AI data workloads. | No margin update; technology-density gains may support future cost position but do not replace current pricing-cycle evidence. | Product sampling is not an operating guide. | Sampling-to-volume timing and NAND cycle volatility remain risks. | Useful product-roadmap confirmation; do not trade as a fresh July 10 catalyst without volume/peer confirmation. |
...
- Product-roadmap updates support the AI storage thesis, but current-cycle pricing and holder-flow still dominate intraday moves.
...
- 2026-07-10: Added BiCS10 sampling source; strengthens NAND roadmap context but not near-term guidance.
